 ...
 */
/*var statArr;
var statArrFile = "normalizing_data.csv"; 
//read in statArr
d3.text(statArrFile, function(text){
...
*/
// Cross filter info.
//var getFilter1Field = function(d) { return d.cadence_kind; };
var getFilter2Field = function(d) { return d.start_number; };
//var domainFilter1 = ["Authentic","NoCadence","Plagal","Phyrgian","CadInCad","CAD NDLT"];
var domainFilter2 = [1,50];
//var rangeFilter1 = [1,7];
var rangeFilter2 = [0,50];
...
function ready(error, csv){
	...
	*/
	...
	//K = 4;
	K  = findk(currentPoints);
        clustering = drawClustering(currentPoints, K);
        displayLabels();
	...
	mainDataCF = crossfilter(mainData),
		...
		filter2All = filter2.group(function(d){ return d;});
